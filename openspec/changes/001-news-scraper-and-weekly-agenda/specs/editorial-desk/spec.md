# editorial-desk Specification (Delta)

## Purpose
Definir los requerimientos funcionales y de datos para la ingesta de noticias y la generación de la pauta editorial semanal del programa.
